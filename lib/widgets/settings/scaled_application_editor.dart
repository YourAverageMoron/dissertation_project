              ...
              children: <Widget>[
                ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return EditScaledApplicationCard(
                          scaledApp: listApps[index]);
                    }
                ),
                RaisedButton(
                  ...
                  onPressed: () =>
                      BlocProvider.of<ScaledApplicationBloc>(context).add(
                          AddScaledApp(testScaledApp)
                      ),
                ),
              ],
            );
